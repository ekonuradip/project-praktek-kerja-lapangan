                                ...
                                while($p = mysqli_fetch_array($arsip)){
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="modal fade" id="exampleModal_<?php echo $p['sidang_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="sidang_hapus.php?id=<?php echo $p['sidang_id']; ?>" class="btn btn-primary"><i class="fa fa-check"></i> &nbsp; Ya, hapus</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal_<?php echo $p['sidang_id']; ?>">
