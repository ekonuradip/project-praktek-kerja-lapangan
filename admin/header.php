    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.php"><img class="main-logo" src="../assets/img/logo/lgg.png" alt="" /></a>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro" style="margin-top: 30px">
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a href="hakim.php" aria-expanded="false"><span class="educate-icon educate-course icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Data JPU</span></a>
                        </li>

                        <li>
                            <a href="data_pendaftar.php" aria-expanded="false"><span class="educate-icon educate-form icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Data akun baru</span></a>
                        </li>
                        ...
                        <li>
                            <a href="tersangka.php" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Data Tersangka</span></a>
                        </li>
                        ...
                        <li>
                            <a href="jadwalsidang.php" aria-expanded="false"><span class="educate-icon educate-data-table icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">jadwal Sidang</span></a>
                        </li>
                        ...
                        <li>
                        <a href="#" aria-expanded="false" data-toggle="modal" data-target="#logoutModal"><span class="educate-icon educate-pages icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Logout</span></a>
                        </li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="index.html"><img class="main-logo" src="../assets/img/logo/lgg.png" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="header-right-info">
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <div role="menu" class="notification-author dropdown-menu animated zoomIn">
                                                        ...
                                                        <div class="notification-single-top">
                                                            <h1>Riwayat upload terakhir</h1>
                                                        </div>
                                                        <ul class="notification-menu">
                                                            <?php 
                                                            $arsip = mysqli_query($koneksi,"SELECT * FROM arsip,petugas WHERE arsip_petugas = petugas_id ORDER BY arsip_id DESC");
                                                                    ...
                                                                    <a href="arsip.php">
                                                                        <div class="notification-content">
                                                                           <p>
                                                                            ...
                                                                            <br>
                                                                            <b><?php echo $p['petugas_nama'] ?></b> mengupload berkas<b><?php echo $p['arsip_nama'] ?></b>.
                                                                        </p>
                                                                    </div>
                                                                </a>
                                                                <hr>
                                                    ...
                                                    <div class="notification-view">
                                                        <a href="arsip.php">Lihat semua riwayat</a>
                                                    </div>
                                                </div>
                                            </li>
                                            ...
                                            <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                ...
                                                <li><a href="#" aria-expanded="false" data-toggle="modal" data-target="#logoutModal"><span class="edu-icon edu-locked author-log-ic"></span>Log Out</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>
