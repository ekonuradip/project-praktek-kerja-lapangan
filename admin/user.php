                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <div class="btn-group">
                                    ...
                                    <a href="user_detail.php?id=<?php echo $p['user_id']; ?>" class="btn btn-default"><i class="fa fa-info-circle"></i></a>
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal_<?php echo $p['user_id']; ?>">
