        ...
        <div class="col-lg-12">
            <div class="panel panel">
                ...
                <div class="panel-body">
                    ...
                    <?php 
                    $id = $_GET['id'];  
                    $data = mysqli_query($koneksi,"SELECT * FROM sidang,hakim,petugas,tersangka WHERE sidang_petugas=petugas_id and sidang_hakim=hakim_id and sidang_nama = tersangka_id and sidang_id='$id'");
