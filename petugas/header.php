    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="indexphpl"><img class="main-logo" src="../assets/img/logo/lgg.png" alt=""/></a>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro" style="margin-top: 30px">
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a href="dataarsip.php" aria-expanded="false"><span class="educate-icon educate-course icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Data Arsip</span></a>
                        </li>
                        ...
                        <li>
                            <a href="jadwalsidang.php" aria-expanded="false"><span class="educate-icon educate-project icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Jadwal Sidang</span></a>
                        </li>

                        <li>
                            <a href="suratjenguk.php" aria-expanded="false"><span class="educate-icon educate-project icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Surat Jenguk</span></a>
                        </li>
