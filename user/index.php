            ...
            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info-cs res-mg-t-30 res-tablet-mg-t-30 dk-res-t-pro-30">
                            <h3 class="box-title">Total Petugas</h3>
                            <ul class="list-inline two-part-sp">
                                ...
                                <li class="text-right graph-three-ctn">
                                    ...
                                    <span class="counter text-info">
                                        <?php 
                                        $jumlah_arsip = mysqli_query($koneksi,"select * from petugas");
                                        ?>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info-cs res-mg-t-30 res-tablet-mg-t-30 dk-res-t-pro-30">
                            <h3 class="box-title">Surat Pengunjung masuk</h3>
                            <ul class="list-inline two-part-sp">
                                <li>
                                ...
                                <li class="text-right graph-four-ctn">
                                    ...
                                    <span class="text-danger">
                                        <?php 
                                        $jumlah_kategori = mysqli_query($koneksi,"select * from pengunjung");
                                        ?>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info-cs res-mg-t-30 res-tablet-mg-t-30 dk-res-t-pro-30">
                            <h3 class="box-title">Jumlah Sidang</h3>
                            <ul class="list-inline two-part-sp">
                                <li>
                                ...
                                <li class="text-right graph-four-ctn">
                                    ...
                                    <span class="text-danger">
                                        <?php 
                                        $jumlah_sidang = mysqli_query($koneksi,"select * from sidang");
                                        ?>
                                        <span class="counter"><?php echo mysqli_num_rows($jumlah_sidang); ?></span>
                                    </span>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="product-sales-chart">
                    ...
                    <center>
                        ...
                        <h3></h3>
                        <h4>Sistem Pengarsipan Berkas dan Pengurusan surat kunjungan tahanan</h4>
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                ...
                <div class="single-cards-item">
                    ...
                    <div class="single-product-text">
                        ...
                        <h5>user</h5>
                        <p class="ctn-cards">Halo, Selamat datang di sistem pengarsipan berkas Pidana Umum Kejaksaan Negeri Magetan</p>
                    </div>
                </div>
