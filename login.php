    ...
    <div class="error-pagewrap">
        <div class="error-page-int">
            <div class="text-center m-b-md custom-login">
                <h3>SISTEM PENGARSIPAN BERKAS</h3>
                <h4></h4>
            ...
            <div class="content-error">
                ...
                if(isset($_GET['alert'])){
                    if($_GET['alert'] == "gagal"){
                        ...
                        echo "<div class='alert alert-info'>Selamat, anda telah sukses melakukan registrasi, Akun anda siap digunakan pada jam 16.00 WIB setiap hari kerja</div>";
                    }
                }
                ?>
                <div class="hpanel">
